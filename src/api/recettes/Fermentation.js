...
export default class Fermentation {
  ...
  getPrimaryTemp (unit) {
    if (this.displayPrimaryTemp) {
      return Utils.convertTo(this.displayPrimaryTemp, unit)
    } else {
  ...
  getSecondaryTemp (unit) {
    if (this.displaySecondaryTemp) {
      return Utils.convertTo(this.displaySecondaryTemp, unit)
    } else {
  ...
  getTertiaryTemp (unit) {
    if (this.displayTertiaryTemp) {
      return Utils.convertTo(this.displayTertiaryTemp, unit)
    } else {
  ...
  getAgeTemp (unit) {
    if (this.displayAgeTemp) {
      return Utils.convertTo(this.displayAgeTemp, unit)
    } else {
      return this.ageTemp
    }
  }
