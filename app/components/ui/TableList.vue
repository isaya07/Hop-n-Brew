  ...
  <div class="txtcenter">
    ...
    <div class="center">
      <table class="rounded">
        <thead>
          <tr>
            <th class="small" v-for="key in columns" @click="sortBy(key)" :class="{ active: sortKey == key }">
              {{ key | capitalize }}
        ...
        <tbody>
          <tr v-for="entry in filteredData">
            <td v-for="key in columns" @dblclick="editable($event,key,entry)" :data-th="key | capitalize">
              {{entry[key]}}
            </td>
            <td data-th='Action'>
