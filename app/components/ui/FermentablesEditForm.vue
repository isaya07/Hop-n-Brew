    ...
    <form>
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="name" v-model="formData.name" v-validate:name.initial="'required|myAlpha'" :class="{'is-alert': errors.has('name') }" type="text" placeholder="Name">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="supplier" v-model="formData.supplier" v-validate:supplier.initial="'myAlpha'" :class="{'is-alert': errors.has('supplier') }" type="text" placeholder="supplier">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="origin" v-model="formData.origin" v-validate:origin.initial="'myAlpha'" :class="{'is-alert': errors.has('origin') }" type="text" placeholder="origin">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="color" v-model="formData.color" v-validate:color.initial="'required|myNumeric'" :class="{'is-alert': errors.has('color') }" type="number" step=".1" placeholder="Couleur">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="yield" v-model="formData.yield" v-validate:yield.initial="'required|myNumeric'" :class="{'is-alert': errors.has('yield') }" type="number">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="maxInBatch" v-model="formData.maxInBatch" v-validate:maxInBatch.initial="'required|myNumeric'" :class="{'is-alert': errors.has('maxInBatch') }" type="number" step="any">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="inventory" v-model="formData.inventory" v-validate:inventory.initial="'myNumeric'" :class="{'is-alert': errors.has('inventory') }" type="number" step="any">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="potential" v-model="formData.potential" v-validate:potential.initial="'myNumeric'" :class="{'input': true, 'is-alert': errors.has('potential') }" type="number" step="any">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="coarseFineDif" v-model="formData.coarseFineDif" v-validate:coarseFineDif.initial="'myNumeric'" :class="{'is-alert': errors.has('coarseFineDif') }" type="number" step="any">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="moisture" v-model="formData.moisture" v-validate:moisture.initial="'myNumeric'" :class="{'is-alert': errors.has('moisture') }" type="number" step="any">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="diastaticPower" v-model="formData.diastaticPower" v-validate:diastaticPower.initial="'myNumeric'" :class="{'is-alert': errors.has('diastaticPower') }" type="number" step="any">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="proteine" v-model="formData.proteine" v-validate:proteine.initial="'myNumeric'" :class="{'is-alert': errors.has('proteine') }" type="number" step="any">
      ...
      <div class="grid-4">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="ibuGalPerLb" v-model="formData.ibuGalPerLb" v-validate:ibuGalPerLb.initial="'myNumeric'" :class="{'is-alert': errors.has('ibuGalPerLb') }" type="number" step="any">
        ...
        <div class="col is-1-3">
          <input class="pure-input-1" name="price" v-model="formData.price" v-validate:price.initial="'myNumeric'" :class="{'is-alert': errors.has('price') }" type="number" step="any">
      ...
      <div class="grid-4">
        ...
        <div class="col is-5-6">
          <textarea class="pure-input-1" name="notes" v-model="formData.notes" v-validate:notes.initial="'myAlpha'" :class="{'is-alert': errors.has('notes') }" type="text"></textarea>
