...
export default class Equipment {
  ...
  getBoilSize (unit) {
    if (this.displayBoilSize) {
      return Utils.convertTempTo(this.displayBoilSize, unit)
    } else {
  ...
  getBatchSize (unit) {
    if (this.displayBatchSize) {
      return Utils.convertTempTo(this.displayBatchSize, unit)
    } else {
  ...
  getTunVolume (unit) {
    if (this.displayTunVolume) {
      return Utils.convertVolTo(this.displayTunVolume, unit)
    } else {
  ...
  getTunWeight (unit) {
    if (this.displayTunWeight) {
      return Utils.convertWeightTo(this.displayTunWeight, unit)
    } else {
