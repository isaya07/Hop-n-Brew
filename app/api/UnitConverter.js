...
export default class UnitConverter {
  constructor (value, unit) {
    ...
    UnitConverter.addUnit('g', 'lbs', 453.59237)
    ...
    UnitConverter.addUnit('l', 'gal', 3.785411784)
    // UnitConverter.addUnit('l', 'Imp fl-oz', 3.7854)
    UnitConverter.addUnit('l', 'imp gal', 4.54609)
    UnitConverter.addUnit('l', 'tsp', 0.00492892)
    UnitConverter.addUnit('l', 'tblsp', 0.0147868)

    UnitConverter.addUnit('c', 'c', 1)
